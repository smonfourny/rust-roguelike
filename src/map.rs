...
impl Map {
    ...
    pub fn new_map(max_x: i32, max_y: i32) -> Map {
        ...
        for _ in 0..MAX_ROOMS {
            ...
            if map.rooms.iter().all(|other_room| !new_room.intersect(&other_room)) && !new_room.out_of_bounds(&map) {
...
impl Rect {
    ...
    pub fn out_of_bounds(&self, map: &Map) -> bool {
        ...
        corners.iter().any(|&corner| corner.0 > map.width as i32 || corner.1 > map.height as i32)
    }
}
